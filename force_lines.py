    ...
    for i in ch_list:
        ...
        for j in range(0, 360, 90):
            ...
            while is_in_borders(cur_x, cur_y) and is_outside_ch(cur_x, cur_y, ch_list, i):
                ...
                if counter % 200 == 0:
                    canvas.create_line(cur_x, cur_y, new_x, new_y, tags='lines', width=1, arrow=i.arrow)
                else:
                    canvas.create_line(cur_x, cur_y, new_x, new_y, tags='lines', width=1)
                counter += 1
                canvas.update()
